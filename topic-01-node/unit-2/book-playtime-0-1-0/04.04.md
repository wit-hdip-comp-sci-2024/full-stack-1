...
![](img/09.png)*VSCode* (perhaps issue is with my browser as in viewing from another browser the images are presented)
...
![](img/11.png)  (perhaps issue is with my browser as in viewing from another browser the images are presented)
